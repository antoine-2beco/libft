...
#    Updated: 2024/05/15 13:26:02 by ade-beco         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS_PERS	=	ft_putstr.c ft_putchar.c ft_printf.c ft_printf_utils.c get_next_line.c ft_lstget.c ft_strappend.c ft_string_to_lst.c ft_lst_to_string.c ft_strsmaller.c ft_strcmp.c
